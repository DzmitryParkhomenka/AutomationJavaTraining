...
import ftm.mailclienttest.pageobject.AccountPage;
import ftm.mailclienttest.pageobject.DraftPage;
import ftm.mailclienttest.pageobject.EmailPopUp;
import ftm.mailclienttest.pageobject.HomePage;
import ftm.mailclienttest.pageobject.LoggedIconPopUp;
import ftm.mailclienttest.pageobject.RightPanel;
import ftm.mailclienttest.pageobject.SentPage;
...
public class PageObjectMailClientTest {
	...
	public void login() {
		...
		Assert.assertTrue(homePage.driver.findElement(homePage.getEmailLoggedIcon()).isDisplayed(), "Logged icon is not displayed");
	}
